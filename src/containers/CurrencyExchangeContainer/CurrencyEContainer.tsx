...
const CurrencyEContainer: React.FC = () => {
    ...
    // const isBuying = useSelector(selectCurrencyIsBuying)
    // const amountOfBYN = useSelector(selectCurrencyAmountOfBYN)
    // const amountOfCurrency = useSelector(selectCurrencyAmountOfCurrency)
